...
export default function ExperiencePage() {
  ...
  const metrics = [
    { icon: TrendingUp, value: '280%', label: 'FY25 Quota' },
    { icon: Target, value: '320%', label: 'Peak Quarter' },
    { icon: Users, value: '100%', label: 'GRR Rate' },
    { icon: Award, value: `${awards.length}`, label: 'Awards 2024' },
  ];
    ...
    >
      <div className="container">
        ...
        <motion.div variants={itemVariants} className="text-center section-padding">
          <h1 className="mb-6">
            Professional <span className="text-chocolate">Experience</span>
          </h1>
            ...
            <div className="card-clean h-full">
              <div className="mb-6">
                <h3 className="text-xl font-heading font-bold flex items-center gap-2">
                  <Award className="w-5 h-5 text-chocolate" />
                  Awards & Recognition
                </h3>
              </div>
                ...
                {awards.map((award, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-chocolate mb-1">{award.organization}</p>
          ...
          <motion.div variants={itemVariants}>
            <div className="card-clean h-full">
              ...
              <div className="space-y-4">
                {certifications.map((cert, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-chocolate mb-1">{cert.issuer}</p>
                    ...
                    {cert.url && (
                      <a
                        ...
                        className="text-xs text-chocolate hover:underline"
                      >
                        View
                      </a>
                    )}
                ...
                {/* Additional Learning */}
                <motion.div
                  className="p-4 rounded-xl border-2 border-dashed border-neutral-300 bg-neutral-50"
                  initial={{ opacity: 0, scale: 0.95 }}
                  animate={{ opacity: 1, scale: 1 }}
                  transition={{ duration: 0.4, delay: 0.5 }}
                >
                  <div className="text-center">
                    <BookOpen className="w-8 h-8 mx-auto text-chocolate mb-2" />
        ...
        <motion.div variants={itemVariants} className="mb-20">
          <div className="card-clean">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                <div className="w-16 h-16 bg-neutral-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
                  <Users className="w-8 h-8 text-chocolate" />
                </div>
              ...
              <div className="text-center">
                <div className="w-16 h-16 bg-neutral-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
                  <Target className="w-8 h-8 text-chocolate" />
                </div>
